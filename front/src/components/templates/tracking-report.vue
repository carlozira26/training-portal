<template>
	<v-card flat>
		...
		<v-card-content>
			<v-layout>
				<v-flex md2 class="pa-1">
					<v-select label="Search by Batch" solo></v-select>
				</v-flex>
				<v-flex md2 class="pa-1">
					<v-select label="Search by Batch" solo></v-select>
				</v-flex>
				...
				<v-flex md2 class="pa-1">
					<v-btn large class="primary">DOWNLOAD</v-btn>
				</v-flex>
			</v-layout>
		</v-card-content>
		<v-card-text style="overflow-y:auto; width: 94%">
			<table class="v-datatable v-table" style="width:100%;border-collapse:collapse">
				<thead>
					<tr>
						<th>FIRST NAME</th>
						<th>MIDDLE NAME</th>
